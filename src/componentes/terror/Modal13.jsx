...
export default function Modal13() {
    const [estadoModal13, setEstadoModal13] = useState(false);
  return (
    <div>
    <ContenedorBotones>
    
    <Boton onClick={()=> setEstadoModal13(!estadoModal13)}><VscPlay/> Play</Boton>
    <Boton><VscBookmark/></Boton>
    <Boton><VscHeartFilled/></Boton>
    </ContenedorBotones>
    <Ventanamodal
    estado={estadoModal13}
    cambiarEstado={setEstadoModal13}
    mostrarHeader={false}
    ...
    >
        <Contenido>
            <ReactPlayer
             url="https://www.youtube.com/watch?v=0JO-TDrWm7k"
             margin="top"
             width="100%"
             height="50%"
             controls
